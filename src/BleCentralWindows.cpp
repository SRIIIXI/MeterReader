...
void BleCentral::ConnectPeripheral()
{
    ...
    if(localDevice)
    {
        ...
        connect(localDevice, SIGNAL(error(QBluetoothLocalDevice::Error)), this, SLOT(OnErrorOccurred(QBluetoothLocalDevice::Error)));
    ...
    if(uartCentral)
    {
        ...
        connect(uartCentral, SIGNAL(error(QLowEnergyController::Error)),  this, SLOT(OnControllerError(QLowEnergyController::Error)));
    }
...
void BleCentral::QueryServiceDetails()
{
    ...
    connect(uartService, SIGNAL(error(QLowEnergyService::ServiceError)), this, SLOT(OnServiceError(QLowEnergyService::ServiceError)));
